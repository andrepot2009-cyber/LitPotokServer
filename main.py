...
class MainWindow(QMainWindow):
    ...
    def setup_editor_page(self):
        ...
        # 🔧 ИСПРАВЛЕНИЕ: редактор доступен писателям по умолчанию
        if self.role == "reader":
            self.editor.setReadOnly(True)
        # writers can edit by default
        ...
        # Показываем кнопку публикации только писателям
